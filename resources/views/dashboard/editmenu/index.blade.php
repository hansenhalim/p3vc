  ...
  <div class="container-fluid">
    <div class="fade-in">
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <x-card-header>Menu Elements List</x-card-header>
            <div class="card-body">
              <div class="row mb-3 ml-0">
                <a
                  class="btn btn-primary"
                  href="{{ route('menu.create') }}"
                >Add new menu element</a>
              </div>
              <div class="row mb-3">
                <div class="col-sm-4">
                  <form
                    ...
                    @if ($menuel['slug'] === 'link')
                      <tr>
                        ...
                        <td>
                          <a
                            class="btn btn-primary"
                            href="{{ route('menu.show', ['id' => $menuel['id']]) }}"
                          >Show</a>
                        </td>
                        <td>
                          <a
                            class="btn btn-primary"
                            href="{{ route('menu.edit', ['id' => $menuel['id']]) }}"
                          >Edit</a>
                        </td>
                        <td>
                          <a
                            class="btn btn-danger"
                            href="{{ route('menu.delete', ['id' => $menuel['id']]) }}"
                          >Delete</a>
                        </td>
                      </tr>
